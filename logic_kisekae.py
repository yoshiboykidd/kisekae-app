...
# --- 1. 定義データ (v3.0 黄金律: Identity & Body Volume) ---
HAIR_STYLES = {
...
def show_kisekae_ui():
    ...
    # --- サイドバー定義 (ここ以外にサイドバー要素は書きません) ---
    with st.sidebar:
        # メニュー選択 (唯一の切り替えボタン)
        menu = st.radio("機能選択", ["✨ AI KISEKAE", "👕 洋服制作君"], key="v3_final_menu")
